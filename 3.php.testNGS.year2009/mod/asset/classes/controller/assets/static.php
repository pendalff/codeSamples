 ...
 * will search your SMVC include paths for a file called
...
class Controller_Assets_Static extends Controller_Assets
{
	public function action_index()
	{
		...
		// Break up file path into the parts needed by SMVC::find_file
		...
		$path = SMVC::find_file($first_directory, $rest_of_path, $pathinfo['extension']);
