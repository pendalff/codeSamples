<?php
/**
 * ClusterWsdlGenerator generates the WSDL for a given service class.
 *
 ...
 * @since 1.0
 */
class ClusterWsdlGenerator extends CComponent
{
	/**
   ...
   */
	public function generateWsdl( array $classNames, $serviceUrl, $encoding='UTF-8')
	{
      ...
      reset($classNames);
			$this->serviceName= current($classNames);
      reset($classNames);
    }
		if($this->namespace===null)
			$this->namespace="urn:{$this->serviceName}wsdl";
