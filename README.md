codeSamples
===========
1. Модуль yii, реализующий функционал xslt рендера, включает в себя ряд инструментов для вызова виджетов/методов посредством простого, конфигурируемого xml-диалекта. 
...
```
2. Компонет для аггрегации данных из различных источков в различных форматах, реально используется в коммерческом проекте для организации кластера мастер-слейв. Весь код, который может представлять коммерческую тайну вырезан, оставлены только самые общие вещи.
